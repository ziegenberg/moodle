...
final class plugin_manager_test extends \advanced_testcase {
    ...
    public function test_plugin_manager_deprecated_plugintype(): void {
        ...
        $plugintypename = "Full Fake";
        $plugintypenameplural = "Full Fakes";
        $stringmanager->mock_string('type_fake', 'core_plugin', $plugintypename);
        $stringmanager->mock_string('type_fake_plural', 'core_plugin', $plugintypenameplural);

        $this->assertEquals('Fake full featured plugin', $pluginman->plugin_name('fake_fullfeatured'));
        $this->assertEquals($plugintypename, $pluginman->plugintype_name('fake'));
        $this->assertEquals($plugintypenameplural, $pluginman->plugintype_name_plural('fake'));
    }
