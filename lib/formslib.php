...
class MoodleQuickForm extends HTML_QuickForm_DHTMLRulesTableless {
    ...
    public function setShowAdvanced(): void { // phpcs:ignore moodle.NamingConventions.ValidFunctionName.LowercaseMethod
        \core\deprecation::emit_deprecation_if_present([self::class, __FUNCTION__]);
    }
     ...
     */
    #[\core\attribute\deprecated(null, since: '2.5', mdl: 'MDL-30637', final: true)]
    public function getShowAdvanced(): void { // phpcs:ignore moodle.NamingConventions.ValidFunctionName.LowercaseMethod
        \core\deprecation::emit_deprecation_if_present([self::class, __FUNCTION__]);
    }
