...
STEPS:
 * Create a temporary folder outside your moodle installation: `cd $(mktemp -d)`
 ...
 * Remove the following files in relation to external testing/analysis that we don't need matrix/:
 ...
 * Xsl files have been removed. These files are for Excel version 5 (created in 1993) and are not used in core code.
   ...
   - PhpSpreadsheet/Reader/XlsBase.php
