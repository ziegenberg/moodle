...
/**
 * Class attempt_walkthrough_from_csv_testcase
 *
 * @package    mod_quiz
 * @copyright  2024 Daniel Ziegenberg
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class attempt_walkthrough_from_csv_testcase extends advanced_testcase {
    ...
    protected static function load_csv_data_file(string $setname, string $test = ''): array {
        $files = [$setname => self::get_full_path_of_csv_file($setname, $test)];
        return self::dataset_from_files($files)->get_rows([$setname]);
    }
