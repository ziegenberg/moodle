...
$string['limiteddisabledfeature'] = 'You are limited to {$a->limit} {$a->feature} on your {$a->plan} plan. {$a->related}<a href="{$a->url}">Learn more</a>';
...
$string['movedqrtopremiumfeatures'] = 'QR code authentication has been moved to the <a href="{$a->url}">{$a->urlname}</a> section. This includes both basic QR code (Free) and automatic QR login ({$a->upgradename}).';
$string['new'] = 'New';
...
$string['qronlypremium'] = '{$a->feature} is only available in Premium. Upgrade to use QR code with automatic login. <a href="{$a->url}">Learn more</a>';
