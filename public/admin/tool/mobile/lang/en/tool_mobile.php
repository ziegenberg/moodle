...
$string['limitedcustomlangstrings'] = 'Total number of <strong>Custom language strings</strong> in your <strong>{$a->plan}</strong> plan: {$a->limit}. <a href="{$a->url}">View plan details</a>.';
$string['limiteddisabledfeatures'] = 'Total number of <strong>Disabled features</strong> in your <strong>{$a->plan}</strong> plan: {$a->limit}. <a href="{$a->url}">View plan details</a>.';
$string['limitedfeatures'] = 'Limited features';
$string['limitedmenuitems'] = 'Total number of items across both <strong>Custom menu items</strong> and <strong>Custom user menu items</strong> in your <strong>{$a->plan}</strong> plan: {$a->limit}. <a href="{$a->url}">View plan details</a>.';
...
$string['missedusers'] = 'Users who have stopped receiving push notifications this month: {$a}.';
