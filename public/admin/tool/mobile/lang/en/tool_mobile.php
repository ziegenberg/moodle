...
$string['qrcodetype_desc'] = 'Mobile users can scan a Quick Response (QR) code to fill in the site URL. For secure (HTTPS) sites, the code also enables automatic login without the user having to enter their username and password.';
