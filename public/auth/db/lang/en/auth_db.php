...
$string['auth_dbhost'] = 'The computer hosting the database server. Use a system Data Source Name (DSN) entry if using Open Database Connectivity (ODBC). Use a PHP Data Objects (PDO) DSN entry if using PDO.';
...
$string['auth_dbmssqlnativeencrypt'] = 'Encrypt connection';
$string['auth_dbmssqlnativeencrypthelp'] = 'Whether the communication with the SQL Server should be encrypted. Only used when the database type is SQL Server (mssqlnative).';
$string['auth_dbmssqlnativetrustservercertificate'] = 'Trust server certificate';
$string['auth_dbmssqlnativetrustservercertificatehelp'] = 'Whether the server certificate authority chain should be validated. Enable this together with an encrypted connection to bypass certificate validation, e.g. when using a self-signed certificate. Only used when the database type is SQL Server (mssqlnative).';
...
$string['auth_dbname_key'] = 'Database name';
...
$string['auth_dbsqlserverconnoptions'] = 'SQL Server connection options';
$string['auth_dbsqlserverconnoptionshelp'] = 'Additional connection options. Some of them only apply to certain database types.';
...
$string['auth_dbtype_deprecated'] = 'Deprecated type';
...
$string['auth_dbuser_key'] = 'Database user';
