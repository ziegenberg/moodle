...
$string['oauth2server_clientcurrentlyrevoked'] = 'This client is currently revoked.';
...
$string['oauth2server_clientrevokeactiondesc'] = 'This immediately inactivates all secrets and stops the client from authenticating. The client, its configuration and secrets are kept, and it can be re-enabled later. To permanently remove it instead, revoke it first, then delete.';
...
$string['oauth2server_secretsinactivewarning'] = 'Any existing or new secrets will remain inactive and cannot be used for authentication until you re-enable the client.';
