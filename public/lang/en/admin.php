...
$string['ipblockersyntax'] = 'Put every entry on one line. Valid entries are either a full IPv4 or IPv6 address (such as <b>192.168.10.1</b> or <b>2001:db8::1</b>) which matches a single host; or a partial address (such as <b>192.168</b> or <b>fe80:1</b>) which matches any address starting with those numbers; or CIDR notation (such as <b>231.54.211.0/20</b> or <b>fe80::/64</b>); or a range of IP addresses (such as <b>231.3.56.10-20</b> or <b>fe80::1111-bbbb</b>) where the range applies to the last part of the address. Text domain names (like \'example.com\') are not supported. Blank lines, and text following a "#" character are ignored.';
