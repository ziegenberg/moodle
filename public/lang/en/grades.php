...
$string['grade_read_scope_summary'] = 'View gradebook data for any user';
$string['grade_read_self_scope_desc'] = 'Allows read-only access to the current user\'s own gradebook including grades, grade items, grade categories and feedback comments.';
$string['grade_read_self_scope_summary'] = 'View your own gradebook';
