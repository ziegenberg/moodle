...
$string['user_create_scope_desc'] = 'Allows access to create user accounts and related data.';
$string['user_create_scope_summary'] = 'Create user accounts';
$string['user_delete_scope_desc'] = 'Allows the site-wide deletion of user accounts and related data.';
$string['user_delete_scope_summary'] = 'Delete any user account';
$string['user_read_scope_desc'] = 'Allows site-wide read-only access to any user account and related data, including user profile information and user preferences.';
$string['user_read_scope_summary'] = 'View any user account';
$string['user_read_self_scope_desc'] = 'Allows read-only access to the current user\'s own account and related data, including user profile and user preferences.';
$string['user_read_self_scope_summary'] = 'View your own user account';
$string['user_update_scope_desc'] = 'Allows site-wide updates to user accounts and related data, including user profile and user preferences.';
$string['user_update_scope_summary'] = 'Update any user account';
$string['user_update_self_scope_desc'] = 'Allows update to the current user\'s own account and related data, including user profile and user preferences.';
$string['user_update_self_scope_summary'] = 'Update your own user account';
