...
class component {
    ...
    protected static $psr4namespaces = [
        ...
        \League\Uri::class => [
            'public/lib/thephpleague/uri',
            'public/lib/thephpleague/uri-interfaces',
        ],
        ...
        \ScssPhp\ScssPhp::class => 'public/lib/scssphp/scssphp/src',
        \SimplePie::class => 'public/lib/simplepie/src',
        \Slim::class => 'public/lib/slim/slim/Slim',
        \SourceSpan::class => 'public/lib/scssphp/source-span/src',
        \Spatie\Cloneable::class => 'public/lib/spatie/php-cloneable/src',
        \Symfony\Component\Filesystem::class => 'public/lib/symfony/filesystem',
