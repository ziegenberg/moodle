...
2. Copy emoji_pretty.json into public/lib/emoji-data/

3. Run the generate_emoji_data.php script to create the new data.js file
   E.g. php public/lib/emoji-data/generate_emoji_data.php > public/lib/amd/src/emoji/data.js

   Once this command has been executed, open the newly created public/lib/amd/src/emoji/data.js file and make sure that the
   ...
   * 'The following categories are missing: xyz, xyz, ...'
      ...
      2. include these categories in the emoji picker template (public/lib/templates/emoji/picker.mustache).
      3. add appropriate icon mappings for these categories in get_core_icon_map() in
         public/lib/classes/output/icon_system_fontawesome.php.
   ...
   * 'The following categories are no longer used: xyz, xyz, ...'
      ...
      2. remove these categories from the emoji picker template (public/lib/templates/emoji/picker.mustache).
   ...
   Rerun the previous command to generate emoji data
   ==================================================================================================================

4. Build the new emoji data.js file
   E.g. grunt amd --files=public/lib/amd/src/emoji/data.js
